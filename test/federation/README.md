...
scripts d'administration et les adresses sortantes de la configuration IA. Ils
ne couvrent pas les passkeys. La partie Android a ses propres tests, côté JVM:
`android/app/src/test`, lancés par `./gradlew test`.
