...
export const BrushIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M20.71 4.63 19.37 3.29c-.39-.39-1.04-.39-1.41 0L9 12.25 11.75 15l8.96-8.96c.39-.39.39-1.02 0-1.41zM8 12a4.8 4.8 0 0 0-4.8 4.8c0 2.1-1.86 3.2-3.2 3.2 1.47 1.95 3.98 3.2 6.4 3.2a6.4 6.4 0 0 0 6.4-6.4 4.8 4.8 0 0 0-4.8-4.8z" />
  </svg>
);
