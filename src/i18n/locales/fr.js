...
loginInsecureContext: "Connexion impossible : votre navigateur bloque certaines fonctions sur les connexions HTTP non sécurisées. Accédez à l'application via HTTPS.",
  ...
  checklistRemoveSection: "Suppression d'une section",
  checklistRemoveSectionDesc: "Choisir le sort des éléments d'une section supprimée.",
  checklistRemoveSectionCascade: "Supprimer les éléments",
  checklistRemoveSectionKeep: "Conserver les éléments",
  gridView: "Vue grille",
