...
loginUnexpectedError: "Impossible de se connecter. Vérifiez votre réseau et réessayez.",
  ...
  remindersNotes: "Rappels",
  reminder: "Rappel",
  reminderTitle: "Rappel",
  reminderLaterToday: "Plus tard aujourd'hui",
  reminderTomorrow: "Demain",
  reminderNextWeek: "Semaine prochaine",
  reminderPickDateTime: "Choisir une date et une heure",
  reminderDateLabel: "Date",
  reminderTimeLabel: "Heure",
  reminderRemove: "Supprimer",
  reminderSet: "Définir",
  reminderUpdate: "Mettre à jour",
  reminderChipToday: "Aujourd'hui {time}",
  reminderChipTomorrow: "Demain {time}",
  reminderChipDate: "{date}, {time}",
  reminderSetToast: "Rappel défini",
  reminderRemovedToast: "Rappel supprimé",
  reminderNotificationTitle: "Rappel",
  reminderOpenNoteAction: "Ouvrir la note",
  reminderPrevMonth: "Mois précédent",
  reminderNextMonth: "Mois suivant",
  reminderHour: "Heure",
  reminderMinute: "Minutes",
  reminderHourUp: "Heure suivante",
  reminderHourDown: "Heure précédente",
  ...
  accessLabel: "Accès",
  accessForNew: "Accès des personnes ajoutées",
  accessForSelected: "Accès des {n} sélectionnée(s)",
  accessForNewHint: "Appliqué à l'ajout, modifiable ensuite pour chacun.",
  ...
  addedCollaboratorsMany: "{n} collaborateurs ajoutés",
  noUsersAvailable: "Aucun utilisateur à ajouter.",
  letterAll: "Tous",
  ...
  importRejected: "{rejected} note(s) illisible(s), non importée(s).",
  ...
  passkeyDomainLabel: "Domaine des passkeys",
  passkeyDomainDesc: "Le domaine auquel vos passkeys appartiennent. Le serveur le lit dans les requêtes qu'il reçoit, mais n'importe qui peut lui en annoncer un autre : il attend donc qu'un administrateur se porte garant du bon.",
  passkeyDomainPlaceholder: "notes.exemple.fr",
  passkeyDomainFromEnv: "Fixé sur le serveur par WEBAUTHN_RP_ID, non modifiable ici :",
  passkeyDomainFromPanel: "Défini ici :",
  passkeyDomainFromCertificate: "Pris dans le certificat HTTPS du serveur, rien à faire :",
  passkeyDomainFromLocal: "Adresse locale, aucun domaine nécessaire :",
  passkeyDomainMissing: "Par sécurité, le serveur ne se servira de ce domaine que si vous vous en portez garant. Vérifiez que celui ci-dessous est bien celui de votre barre d'adresse, puis validez. D'ici là, les passkeys fonctionnent sur une adresse locale mais sont refusées sur un domaine public.",
  ...
  noteSharedReadOnlyToast: "{sender} a partagé la note {title} avec vous en lecture seule",
  ...
  notificationsFilterTitle: "Catégories de notifications",
  notificationsFilterDesc: "Choisissez quels types de notifications afficher",
  notificationsFilterTypesLabel: "Options d'affichage par catégorie",
  filterTypeFederation: "Collaboration entre serveurs (en ligne/hors ligne, couplage…)",
  filterTypeShare: "Notes partagées",
  filterTypeAccess: "Changements d'accès",
  filterTypeReminder: "Rappels",
  filterTypeSuccess: "Réussites (sauvegarde, archivage, corbeille, restauration…)",
  filterTypeWarning: "Avertissements",
  filterTypeError: "Erreurs",
  filterTypeInfo: "Messages d'information",
  ...
  fedActionFailed: "Échec de l'action. Veuillez réessayer.",
  ...
  fedErrClockSkew: "Les horloges des deux serveurs diffèrent de {offset}. Synchronisez l’heure (NTP) sur les deux machines.",
  fedErrClockSkewUnknown: "Les horloges des deux serveurs ne concordent pas. Synchronisez l’heure (NTP) sur les deux machines.",
