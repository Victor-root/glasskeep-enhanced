...
loginFailed: "Échec de la connexion",
  ...
  syncPendingActions: "{count} modification(s) en attente",
  syncAllUpToDate: "Toutes les modifications sont synchronisées.",
  syncOfflineNoChanges: "Vous êtes hors ligne. Aucune modification en attente.",
  syncSuccess: "Synchronisation terminée",
  syncFailed: "Échec de la synchronisation. Nouvel essai quand le serveur sera disponible.",
  syncConflictBackup: "Un conflit a été détecté. Une copie de sauvegarde de votre version locale a été créée.",
  offlineNoteCreated: "Note enregistrée localement (hors ligne)",
  offlineNoteUpdated: "Modifications enregistrées localement (hors ligne)",
  offlineNoteDeleted: "Note supprimée localement (hors ligne)",
  offlineAiUnavailable: "L'IA n'est pas disponible hors ligne",
  loadingNotes: "Chargement des notes…",
  syncActionCreate: "Création",
  syncActionUpdate: "Modification",
  syncActionDelete: "Suppression",
  syncActionTrash: "Corbeille",
  syncActionPermDelete: "Suppr. définitive",
  syncActionArchive: "Archivage",
  syncActionRestore: "Restauration",
  syncActionPin: "Épinglage",
  syncFailedDetails: "Actions échouées :",
  syncOfflinePending: "Les modifications seront synchronisées au retour en ligne.",
};
