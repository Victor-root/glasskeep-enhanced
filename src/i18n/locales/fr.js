...
loginUnexpectedError: "Impossible de se connecter. Vérifiez votre réseau et réessayez.",
  ...
  passkeyDomainDesc: "Le domaine auquel vos passkeys appartiennent. Le serveur le voit passer dans chaque requête, mais rien ne lui dit que c'est le bon : il attend qu'un administrateur le confirme.",
  ...
  passkeyDomainMissing: "Le domaine ci-dessous est celui par lequel vous êtes arrivé sur cette page. Comparez-le à votre barre d'adresse, puis validez : le serveur ne s'en sert qu'après. En attendant, les passkeys fonctionnent sur une adresse locale mais sont refusées sur un domaine public.",
