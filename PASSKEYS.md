...
### "Failed to start passkey registration / login", nothing else in the browser

Look at the server log. A line reading *"Passkeys are not configured
for this domain"* means the server could not establish, on its own,
